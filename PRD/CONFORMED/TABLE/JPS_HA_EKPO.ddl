create or replace TABLE JPS_HA_EKPO (
	MANDT VARCHAR(3),
	EBELN VARCHAR(10),
	EBELP VARCHAR(5),
	LOEKZ VARCHAR(1),
	...
	REQUESTFORQUOTATIONITEM VARCHAR(5),
	...
	SF_TXJCD VARCHAR(15),
	DUMMY_EKPO_INCL_EEW_PS VARCHAR(1),
	EXPECTED_VALUE NUMBER(38,2),
	LIMIT_AMOUNT NUMBER(38,2),
	ENH_DATE1 VARCHAR(8),
	ENH_DATE2 VARCHAR(8),
	ENH_PERCENT NUMBER(38,2),
	ENH_NUMC1 VARCHAR(10),
	_DATAAGING VARCHAR(8),
	NEGEN_ITEM VARCHAR(1),
	NEDEPFREE VARCHAR(1),
	...
	FSH_THEME VARCHAR(4),
	FSH_ATP_DATE VARCHAR(8),
	FSH_VAS_REL VARCHAR(1),
	FSH_VAS_PRNT_ID VARCHAR(5),
	...
	CNFM_QTY NUMBER(38,3),
	STPAC VARCHAR(1),
	LGBZO VARCHAR(10),
	LGBZO_B VARCHAR(10),
	ADDRNUM VARCHAR(10),
	CONSNUM VARCHAR(3),
	BORGR_MISS VARCHAR(1),
	DEP_ID VARCHAR(12),
	BELNR VARCHAR(10),
	KBLPOS_CAB VARCHAR(3),
	KBLNR_COMP VARCHAR(10),
	KBLPOS_COMP VARCHAR(3),
	WBS_ELEMENT VARCHAR(8),
	RFM_PSST_RULE VARCHAR(4),
