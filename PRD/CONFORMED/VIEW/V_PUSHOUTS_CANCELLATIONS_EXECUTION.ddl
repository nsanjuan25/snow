create or replace view V_PUSHOUTS_CANCELLATIONS_EXECUTION(
	CURRENTQUARTER,
	NEXTQUARTER,
	CURRENTFYQUARTER,
	PLANTKEY,
...
*/
SELECT
      TO_CHAR(TO_DATE(CURRENTQUARTER, 'YYYY-MM-DD hh:00:ss'), 'YYYY-MM-DD hh:00:ss') AS CURRENTQUARTER
    , TO_CHAR(TO_DATE(NEXTQUARTER, 'YYYY-MM-DD hh:00:ss'), 'YYYY-MM-DD hh:00:ss')    AS NEXTQUARTER
    , CURRENTFYQUARTER
    , PLANTKEY
    , MATERIALCODE
    , PROFITCENTER
    ...
    , POVALUE
    , DELIVERYFINISHDTS
    , TO_CHAR(TO_DATE(DELIVERYMONTHDATE, 'YYYY-MM-DD hh:00:ss'), 'YYYY-MM-DD hh:00:ss')    AS DELIVERYMONTHDATE
    , TO_CHAR(TO_DATE(DELIVERYDATEQUARTERDATE, 'YYYY-MM-DD hh:00:ss'), 'YYYY-MM-DD hh:00:ss')    AS DELIVERYDATEQUARTERDATE
    , DELIVERYFYQUARTER
    , TO_CHAR(TO_DATE(DELIVERYNEXTQUARTERDATE, 'YYYY-MM-DD hh:00:ss'), 'YYYY-MM-DD hh:00:ss')    AS DELIVERYNEXTQUARTERDATE 
    , TO_CHAR(TO_DATE(DELIVERYQUARTERPLUS2MONTHSDATE, 'YYYY-MM-DD hh:00:ss'), 'YYYY-MM-DD hh:00:ss')    AS DELIVERYQUARTERPLUS2MONTHSDATE
    , MRPCALCDATE
    , RESCHEDULINGDATE
    , RESCHEDULEMONTHDATE
    , RESCHEDULEQUARTERDATE
...
FROM
    (
       ...
       SELECT * from V_CANCELLATIONS_EXECUTION 
       UNION ALL
       select * from V_PUSHOUTS_EXECUTION
     ) as ORI
