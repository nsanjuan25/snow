create or replace view V_ECC_HA_SITEPARTSOURCE_PRICING(
	DATASOURCEKEY,
	SITECODE,
	SITEPARTCODE,
...
(	
	...
	FROM
		CONFORMED.ECC_HA_A017 a 
		LEFT OUTER JOIN CONFORMED.ECC_HA_KONP k ON a.knumh = k.knumh 
			AND a.kappl = k.kappl 
			AND a.kschl = k.kschl 
		LEFT OUTER JOIN CONFORMED.ECC_HA_LFA1 l ON a.lifnr = l.lifnr
) a;