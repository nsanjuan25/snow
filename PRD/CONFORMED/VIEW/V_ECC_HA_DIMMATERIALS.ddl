create or replace view V_ECC_HA_DIMMATERIALS(
	PLANTCODE,
	MATERIALCODE,
	PLANTKEY,
	BUYERKEY,
  ...
  FROM 
      ...
      LEFT OUTER JOIN 
          (
              ...
              FROM
                  conformed.bw_ha_site_Part sp
                  LEFT OUTER JOIN conformed.ecc_ha_tvkwz t ON t.werks = sp.sitecode
                  LEFT OUTER JOIN conformed.ecc_ha_mvke mv ON t.vkorg = mv.vkorg
    ...
    LEFT OUTER JOIN  conformed.ecc_ha_mbew mb 
    ...
    (
        ...
        FROM
            conformed.ecc_ha_t030 t030
            LEFT OUTER JOIN conformed.ecc_ha_skat skat on t030.konts = skat.saknr
        WHERE 
            skat.ktopl     = '0010'
            and skat.spras = 'E'
            and t030.ktopl = '0010'
