create or replace view V_HCC_HA_PLANTS(
	PLANTCODE,
	PLANTNAMESHORT,
	PLANTNAMELONG,
	PLANTTYPECODE,
...
from 
    conformed.hcc_ha_t001w t001w
    LEFT OUTER JOIN  conformed.hcc_ha_t001k t001k
        on  t001w.werks = t001k.bwkey
    LEFT OUTER JOIN  conformed.hcc_ha_t001 t001
        on  t001k.bukrs = t001.bukrs
    LEFT OUTER JOIN conformed.hcc_ha_t399d t399d
        on t001w.werks = t399d.werks
    LEFT OUTER JOIN conformed.hcc_ha_t001a t001a
