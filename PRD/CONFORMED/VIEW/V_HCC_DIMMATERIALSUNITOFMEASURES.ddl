create or replace view V_HCC_DIMMATERIALSUNITOFMEASURES(
	DATASOURCEKEY,
	MATERIALCODE,
	PLANTCODE,
...
This view is used to insert data into V_HCC_DimMaterialsUnitOfMeasures
-----------------------------------------------------------------------------------------------
Revision History
-----------------------------------------------------------------------------------------------
...
LEFT OUTER JOIN CONFORMED.HCC_HA_T006 T006
