create or replace view V_JPS_HA_MRPDETAIL(
	MRPNUMBER,
	MRPITEM,
	MRPAREA,
	MRPPLANNINGSEGMENT,
...
FROM
    ...
    FROM   CONFORMED.JPS_HA_MDTB
) mdtb
INNER JOIN 
      CONFORMED.V_JPS_HA_MRPHEADER AS mrpheader
