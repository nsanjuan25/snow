create or replace view V_ECC_DIMSUPPLIERCOMPANIES(
	SUPPLIERCODE,
	CORPORATIONID,
...
FROM 
	...
	LEFT JOIN CONFORMED.ECC_HA_LFB1 AS LFB ON ESV.lifnr = LFB.lifnr 
    LEFT JOIN CONFORMED.ECC_HA_LFM1 AS LFM ON ESV.lifnr = LFM.lifnr 
