create or replace view V_JPS_DIMMATERIALSUNITOFMEASURES(
	DATASOURCEKEY,
	MATERIALCODE,
	PLANTCODE,
...
----------------------------------------------------------------------------------------------
2021-08-27      Jagan                   Initial Revision     
*/
select 
    '5' DATASOURCEKEY,                                  
	...
	(
        ...
        (
            ...
            inner join 
			    CONFORMED.JPS_HA_MARM marm
                    on marc.matnr = marm.matnr
         ) as temp
    where temp.rownum = 1
    ) marc_marm
LEFT OUTER JOIN CONFORMED.JPS_HA_T006 T006
