create or replace view V_JPS_HA_DIMCURRENCYEXCHANGERATES(
	FROMCURRENCYCODE,
	TOCURRENCYCODE,
	EFFECTIVEFROMDATE,
	EXCHANGERATE,
...
-----------------------------------------------------------------------------------------
2021-07-26      Jagan                   Initial Revision
*/
       ...
       (
        ...
        FROM
            ...
            FROM
                ...
                FROM 
				     CONFORMED.JPS_HA_TCURR tr
                LEFT OUTER JOIN
                    (
                        SELECT *
                        FROM 
						      CONFORMED.JPS_HA_TCURF
                        WHERE 
						      kurst IN ( 'EURX', 'P', 'M' )
                    ) tf
