create or replace view V_ECC_HA_FACTMOVEMENTS(
	MOVEMENTTYPEKEY,
	PLANTKEY,
	MATERIALKEY,
...
FROM
    conformed.ECC_HA_MKPF  mkpf
    INNER JOIN conformed.ECC_HA_MSEG mseg     
    on mkpf.mblnr = mseg.mblnr 
    and mkpf.mjahr = mseg.mjahr
    LEFT OUTER JOIN conformed.ECC_HA_LFA1 lfa1
    ...
    LEFT OUTER JOIN conformed.ecc_ha_prps prps 
