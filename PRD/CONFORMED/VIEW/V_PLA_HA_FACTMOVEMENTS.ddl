create or replace view V_PLA_HA_FACTMOVEMENTS(
	MOVEMENTTYPEKEY,
	PLANTKEY,
	MATERIALKEY,
...
SELECT 
     ...
     , ifnull(to_date(case when mkpf.cpudt = '00000000' then '19000101' else mkpf.cpudt end , 'YYYYMMDD'),'1900-01-01') as transactiondts
...
/*
LEFT OUTER JOIN 
    conformed.PLA_ha_prps prps 
       ON ifnull(mseg.ps_psp_pnr,'') = prps.pspnr*/
;