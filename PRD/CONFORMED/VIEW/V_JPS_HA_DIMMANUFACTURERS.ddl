create or replace view V_JPS_HA_DIMMANUFACTURERS(
	MANUFACTURERCODE,
	CORPORATIONID,
...
----------------------------------------------------------------------------------------------
2021-07-13      Jagan             Initial Revision
*/                         
SELECT 
     ...
     , ''                                       AS DUNSNumber
FROM   
       conformed.JPS_HA_LFA1 as lfa1 
LEFT OUTER JOIN 
       conformed.JPS_HA_LFM1 as lfm1 
