create or replace view V_TM1_ACCOUNT_LVL_HIER_LAKS(
	PARENT,
	ACCOUNT,
	WEIGHT,
	LEVEL,
...
( select  
 ...
 select 
	   ...
	   ,a.lvl + 1  
       ,a.depth + 1
	   ,cast( a.hier || '||' || b.child as string ) from 
 TM1_ACCOUNT_lvl a
 inner join 
...
select 
                a.parent 
               ,a.child 
			   ,cast (a.weight  as decimal(18,6))
			   ,lvl 
               ,depth
			   ,hier  
from TM1_ACCOUNT_lvl a
where  a.parent not in ( select child from TM1_ACCOUNT_lvl);