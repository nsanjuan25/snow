create or replace view V_HCC_FACTMATERIALSTANDARDPRICEHISTORY(
	MATERIALKEY,
	STDUNITCOSTP0,
...
This view is used to insert data into v_HCC_FactMaterialStandardPriceHistory
-----------------------------------------------------------------------------------------------
Revision History
-----------------------------------------------------------------------------------------------
