create or replace view V_JPS_HA_FACTPURCHASEORDERS(
...
FROM
    (
      ...
      FROM
          conformed.jps_ha_ekko ekko
          INNER JOIN conformed.jps_ha_ekpo ekpo 
              ...
              (
                  ...
                  from 
                      (
                          ...
                          from 
                              conformed.jps_ha_eine p 
                              inner join conformed.jps_ha_eina i
          ...
          LEFT JOIN conformed.jps_ha_tcurx TCURX 
...
*/
   ...
   -- //LEFT OUTER JOIN (select  DISTINCT rcvprn from  conformed.jps_ha_EDP13 WHERE mestyp IN ('DELINS', 'ORDCHG', 'ORDERS', 'ZSM') ) e ON pos.SupplierCorporationDSCode = e.rcvprn
