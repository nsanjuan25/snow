create or replace view V_ECC_HA_MOVEMENT(
	DATASOURCEKEY,
...
FROM 
	...
	INNER JOIN CONFORMED.ECC_HA_MSEG mseg ON mkpf.mblnr = mseg.mblnr 
	AND mkpf.mjahr = mseg.mjahr 
	LEFT OUTER JOIN CONFORMED.ECC_HA_LFA1 lfa1 ON mseg.lifnr = lfa1.lifnr 
	LEFT OUTER JOIN CONFORMED.ECC_HA_TCURX tcurx ON mseg.waers = TCURX.currkey;